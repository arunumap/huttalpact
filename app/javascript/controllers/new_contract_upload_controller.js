...
export default class extends Controller {
  static targets = ["dropzone", "input", "label", "fileList"]
  ...
  renderFileList() {
    ...
    this.fileListTarget.innerHTML = this.files.map((file, index) => `
      <div class="flex items-center gap-3 rounded-lg bg-white px-4 py-3 ring-1 ring-gray-200">
        ...
        <button type="button" data-action="click->new-contract-upload#removeFile" data-index="${index}" class="text-gray-400 hover:text-red-500">
